...
class GIFOutput {
	constructor() {
		...
		this.defaultGifs.push({
			still: 'https://github.com/49Haacker/Ai-Browsey/blob/master/A.png?raw=true',
			gif: 'https://github.com/49Haacker/Ai-Browsey/blob/master/A.png?raw=true'
		});

		this.defaultGifs.push({
			still: 'https://github.com/49Haacker/Ai-Browsey/blob/master/B.png?raw=true',
			gif: 'https://github.com/49Haacker/Ai-Browsey/blob/master/B.png?raw=true'
		});

		this.defaultGifs.push({
			still: 'https://github.com/49Haacker/Ai-Browsey/blob/master/C.png?raw=true',
			gif: 'https://github.com/49Haacker/Ai-Browsey/blob/master/C.png?raw=true'
		});
